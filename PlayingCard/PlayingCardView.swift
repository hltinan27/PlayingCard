...
class PlayingCardView: UIView {
  @IBInspectable
  var rank: Int = 2 {didSet{ setNeedsDisplay(); setNeedsLayout() }}
  @IBInspectable
 ...
 @objc func addJustFaceCardScale(recognizer : UIPinchGestureRecognizer){
  ...
  //Cihaz FontSize Değişikligini algılar
...
extension PlayingCardView {
  private struct SizeRatio {
    ...
    static let cornerRadiusToBoundsHeight: CGFloat = 0.2
